            ...
            switch (preset)
            {
                ...
                case Preset.BLM_AoE_Triplecast:
                    DrawSliderInt(0, 1, BLM_AoE_TriplecastHoldCharges,
                        $"保留多少次{Triplecast.ActionName()}充能？（0为全部使用）");
                    break;
