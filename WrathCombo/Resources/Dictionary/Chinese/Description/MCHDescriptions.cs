    ...
    public static class MCHDesc
    {
        public static IEnumerable<KeyValuePair<string, string>> GetDescriptions()
        {
            ...
            [
                ...
                KeyValuePair.Create("Adds Gauss Round and Ricochet or Double Check and Checkmate to the rotation.", "将Gauss Round和Ricochet或Double Check和Checkmate添加到循环中。（至少选择一个）"),
