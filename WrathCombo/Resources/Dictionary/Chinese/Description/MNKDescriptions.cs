    ...
    public static class MNKDesc
    {
        public static IEnumerable<KeyValuePair<string, string>> GetDescriptions()
        {
            ...
            [
                ...
                KeyValuePair.Create("will use it only under RoF when unlocked.", "只有在红莲极意解锁时使用。"),
                ...
                KeyValuePair.Create($"Stop Using {PerfectBalance.ActionName()} When Target HP% is at or Below (Set to 0 to Disable This Check)", $"当目标生命百分比达到或低于此值时停止使用{PerfectBalance.ActionName()}（设置为0以禁用此检查）"),
